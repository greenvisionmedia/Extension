!function (m) {
  ...
  6: function (formatters, customFormatters) {
    var r;
    var selector;
    var parentExpNode;
    var node;
    r = chrome.runtime.getURL("js/udesly-main.js");
    /** @type {string} */
    selector = "body";
    /** @type {!Element} */
    parentExpNode = document.getElementsByTagName(selector)[0];
    (node = document.createElement("script")).setAttribute("type", "text/javascript");
    node.setAttribute("src", r);
    parentExpNode.appendChild(node);
  }
});